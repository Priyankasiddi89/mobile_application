  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh" }}>
      ...
      <main style={{ flex: 1, padding: "32px", background: "#f8f9fa" }}>
        ...
        {section && section !== "profile" && section !== "requests" && section !== "services" && <ServiceProviderDashboard user={user} />}
      </main>
    </div>
  );
}
  ...
  return (
    <div style={{ background: 'white', borderRadius: 16, padding: 32, maxWidth: 600, margin: '40px auto', boxShadow: '0 4px 24px rgba(44, 62, 80, 0.08)' }}>
      ...
      <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
        <button style={{ padding: '10px 24px', borderRadius: 8, background: '#667eea', color: 'white', fontWeight: 600, border: 'none', cursor: 'pointer' }} onClick={() => router.push('/service_provider_dashboard/profile')}>View Profile</button>
    ...
    <div style={{ background: 'white', borderRadius: 16, padding: 32, maxWidth: 800, margin: '40px auto', boxShadow: '0 4px 24px rgba(44, 62, 80, 0.08)' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '20px', marginTop: '24px' }}>
        <div style={{ background: '#f8f9fa', padding: '20px', borderRadius: '12px', border: '1px solid #e9ecef' }}>
          ...
          <button style={{ padding: '8px 16px', borderRadius: 6, background: '#28a745', color: 'white', border: 'none', cursor: 'pointer', fontSize: '14px' }} onClick={() => router.push('/service_provider_dashboard/requests')}>View Requests</button>
        </div>
        ...
        <div style={{ background: '#f8f9fa', padding: '20px', borderRadius: '12px', border: '1px solid #e9ecef' }}>
          ...
          <button style={{ padding: '8px 16px', borderRadius: 6, background: '#17a2b8', color: 'white', border: 'none', cursor: 'pointer', fontSize: '14px' }} onClick={() => router.push('/service_provider_dashboard/services')}>Manage Services</button>
        </div>
        ...
        <div style={{ background: '#f8f9fa', padding: '20px', borderRadius: '12px', border: '1px solid #e9ecef' }}>
          ...
          <button style={{ padding: '8px 16px', borderRadius: 6, background: '#667eea', color: 'white', border: 'none', cursor: 'pointer', fontSize: '14px' }} onClick={() => router.push('/service_provider_dashboard/profile')}>View Profile</button>
        </div>
      </div>
    </div>
  );
