  ...
  return (
    <aside style={{
      ...
      <nav style={{ width: "100%" }}>
        ...
        <SidebarNavItem label="Incoming Bookings" icon="📥" onClick={() => router.push('/service_provider_dashboard/incoming')} />
        ...
        <SidebarNavItem label="Profile" icon="👤" onClick={() => router.push('/service_provider_dashboard/profile')} />
        <SidebarNavItem label="Help" icon="❓" onClick={() => router.push('/service_provider_dashboard/help')} />
