#!/usr/bin/env python
"""
Quick script to populate services in the database
"""
import os
import django
...
def populate_services():
    """Populate database with service categories and subcategories"""
    print('🚀 Starting to populate service categories and subcategories...')
    ...
    print('\n🎉 Successfully populated database with service categories and subcategories!')
